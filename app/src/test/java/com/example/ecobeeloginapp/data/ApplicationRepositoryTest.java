...
@PrepareForTest({ApplicationRepository.class, LoginDataSource.class, ApiServiceInterface.class, ApiClient.class})
...
public class ApplicationRepositoryTest {
    ...
    public void testLoginRepository() {
        ...
        ApplicationRepository applicationRepository = ApplicationRepository.getApplicationRepository();
        Single<LoginAuthResult> loginRepoResponse = applicationRepository.login(user);
    ...
    public void testLoginRepositoryWithNullApiService() {
        ...
        ApplicationRepository applicationRepository = ApplicationRepository.getApplicationRepository();
        Single<List<CatApiResponse>> catApiResponse = applicationRepository.getCatImageDetails();
